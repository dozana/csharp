                        ...
                        using (SqlCommand checkUser = new SqlCommand(selectUsername, connect))
                        {
                            ...
                            else
                            {
                                ...
                                using (SqlCommand cmd = new SqlCommand(insertData, connect))
                                {
                                    ...
                                    cmd.Parameters.AddWithValue("@password", signup_username.Text.Trim());
                                    cmd.Parameters.AddWithValue("@dateReg", today);

                                    cmd.ExecuteNonQuery();

                                    MessageBox.Show("Registered Seccessfully.", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            try
            {
                ...
                using (SqlCommand checkUser = new SqlCommand(selectUsername, connect))
                {
                    ...
                    else
                    {
                        ...
                        {
                            cmd.Parameters.AddWithValue("@username", signup_username.Text.Trim());
                            cmd.Parameters.AddWithValue("@password", signup_password.Text.Trim()); // Use the actual password
                            cmd.Parameters.AddWithValue("@dateReg", today);
